      ...
      <Tabs defaultValue="profile">
        ...
        <TabsContent value="org" className="mt-4">
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="flex flex-col gap-1.5"><Label>Company Name</Label><Input defaultValue="TransitOps Logistics Pvt. Ltd." /></div>
        ...
        <TabsContent value="api" className="mt-4">
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="flex flex-col gap-1.5"><Label>API Base URL</Label><Input placeholder="https://api.transitops.io/v1" /></div>
