...
export const Route = createFileRoute("/users")({
  ssr: false,
  head: () => ({ meta: [{ title: "Users — TransitOps" }] }),
...
const USERS: Row[] = [
  { id: "u1", name: "Priya Sharma", email: "priya@transitops.io", role: "Administrator", status: "Active", lastLogin: "2 min ago" },
  { id: "u2", name: "Arjun Mehta", email: "arjun@transitops.io", role: "Fleet Manager", status: "Active", lastLogin: "1 hour ago" },
  { id: "u3", name: "Deepak Bansal", email: "deepak@transitops.io", role: "Safety Officer", status: "Active", lastLogin: "Yesterday" },
  { id: "u4", name: "Anita Rao", email: "anita@transitops.io", role: "Financial Analyst", status: "Active", lastLogin: "3 days ago" },
  { id: "u5", name: "Rajesh Kumar", email: "rajesh.k@transitops.io", role: "Driver", status: "Active", lastLogin: "5 min ago" },
  { id: "u6", name: "Anil Verma", email: "anil.v@transitops.io", role: "Driver", status: "Suspended", lastLogin: "2 weeks ago" },
];
